...
public class Members {
    ...
    public Members(String _id, String member_user, String member_password, String member_email, String member_fname, String member_lname, String member_class, Integer member_no, String member_dob, String member_address, String member_img, String member_level, String member_timestamp) {
        this._id = _id;
