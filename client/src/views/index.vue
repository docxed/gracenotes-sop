      ...
      <div class="content">
        ...
        <template v-if="$v.user.$error">
          ...
          <p class="help text-danger" v-if="!$v.user.maxLength">
            This field can contain only 10 characters
          </p>
          <p class="help text-danger" v-if="!$v.user.numeric">
            This field can contain number only
          </p>
        </template>
        ...
        <template v-if="$v.pass.$error">
          ...
          <p class="help text-danger" v-if="!$v.pass.maxLength">
